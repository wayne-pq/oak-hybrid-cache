...
create table u_task_detail_2025_0
(
...
create table u_task_detail_2025_1
(
    id          bigint auto_increment comment '主键'
        primary key,
    version     int      default 0                 not null comment '版本号',
...
create table u_task_detail_2025_2
(
    id          bigint auto_increment comment '主键'
        primary key,
    version     int      default 0                 not null comment '版本号',
...
create table u_task_detail_2025_3
(
    id          bigint auto_increment comment '主键'
        primary key,
    version     int      default 0                 not null comment '版本号',
...
create table u_task_detail_2024_0
(
    id          bigint auto_increment comment '主键'
        primary key,
    version     int      default 0                 not null comment '版本号',
...
create table u_task_detail_2024_1
(
    id          bigint auto_increment comment '主键'
        primary key,
    version     int      default 0                 not null comment '版本号',
...
create table u_task_detail_2024_2
(
    id          bigint auto_increment comment '主键'
        primary key,
    version     int      default 0                 not null comment '版本号',
...
create table u_task_detail_2024_3
(
    id          bigint auto_increment comment '主键'
        primary key,
    version     int      default 0                 not null comment '版本号',
...
create table u_task_progress_2024_3
(
    id varchar(70) not null comment '主键'
        primary key,
    version              int     default 0 not null comment '版本号',
...
create table u_task_progress_2025_3
(
    id varchar(70) not null comment '主键'
        primary key,
    version              int     default 0 not null comment '版本号',
